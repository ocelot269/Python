...
static void Yatzy_scores_50(void) 
{
    int expected = 50;
    int actual = Yatzy().yatzy(ints(4,4,4,4,4));
    assert(expected == actual);
    assert(50 == Yatzy().yatzy(ints(6,6,6,6,6)));
    assert(0 == Yatzy().yatzy(ints(6,6,6,6,3)));
}
...
{
    assert(12 == (new Yatzy(4,4,4,5,5))->Fours());
    assert(8 == (new Yatzy(4,4,5,5,5))->Fours());
    assert(4 == (*new Yatzy(4,5,5,5,5)).Fours());
}

static void fives() {
    assert(10 == (new Yatzy(4,4,4,5,5))->Fives());
...
{
    assert(6 == Yatzy().ScorePair(3,4,3,5,6));
    assert(10 == Yatzy().ScorePair(5,3,3,3,5));
    assert(12 == Yatzy().ScorePair(5,3,6,6,5));
}

static void two_Pair() 
{
    assert(16 == Yatzy().TwoPair(3,3,5,4,5));
    assert(16 == Yatzy().TwoPair(3,3,5,5,5));
}
